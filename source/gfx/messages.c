...
[LOG_MSG_KEYS_DUMP_INFO_NEW_MASTER_KEYS]   = "New keys derived for master_key_%02x",
	[LOG_MSG_KEYS_DUMP_WARN_MASTER_KEK_SOURCE]   = "Warning: master_kek_source missing for revisions %02x-%02x.",
	[LOG_MSG_KEYS_DUMP_INFO_UP_TO_DATE_KEY_GENERATION]   = "Key generation up to date.",
